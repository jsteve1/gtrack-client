...
import MainActionMenu from './containers/ui/mainactionmenu';
function App() {
        ...
        <CookiesProvider>
          <BrowserRouter>
            ...
            <Router showActionButton={showActionButton} setShowActionButton={setShowActionButton} />
            {
              (showActionButton) ? 
                <>
                    <MainActionMenu showAction={showAction} setShowAction={setShowAction} />
                    <Icon.PlusCircleFill  className="goals-list-action-button" width={100} height={100} onClick={() => setShowAction(!showAction) } />
                </>
                : 
                ""
            }
            {
              (showActionButton) ? <ActionAdd show={false} setShow={setShowAction} /> : ""
            }
          </BrowserRouter>
        </CookiesProvider>
      </Provider>
